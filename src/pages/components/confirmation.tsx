...
type alertProps = {
  ...
  setConfirmDeletion: Dispatch<React.SetStateAction<boolean>>;
  deleteRow: any;
  index: number;
};
          ...
          <div className="relative rounded-lg bg-white shadow dark:bg-gray-700">
            ...
            <div className="flex items-center space-x-2 rounded-b border-t border-gray-200 px-6 py-4 dark:border-gray-600">
              <button
                ...
                data-modal-toggle="defaultModal"
                type="button"
                className="rounded-lg bg-red-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              >
                Cancelar
              </button>
              <button
